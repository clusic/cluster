...
const [killStatus, killing, appFramework, argv, init, onMessage, eventTree, installed, kill, destroy, logger, processTimer] = [
...
new (class Application extends IPC {
  constructor(processArgvArray) {
    ...
    this[appFramework] = new (this[argv].type === 'agent'
      ? loadFile(this[argv].framework + '/agent.js')
      : loadFile(this[argv].framework + '/app.js'))(this, this[argv]);
