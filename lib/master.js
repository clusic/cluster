...
const [killing, config, createSocketServer, socketServer, onMessage, forkAgents, agentSendBack, waitAgentsDone, workerSendBack, workerDead, forkWorkers, waitWorksDone] = [
 ...
 * @param debug {boolean|string} <default: false> 是否开启调试以及调试模式 --inspect-brk
